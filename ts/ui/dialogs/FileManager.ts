...
import { UISimpleTable } from '../controls/UISimpleTable'
...
export class FileManager {
  ...
  private readonly fileName: UI.Edit
  private direction: Label
  private readonly address: Panel
  private readonly btn: UI.Button
  ...
  constructor() {
    ...
    this.btn = new UI.Button({caption: "Create folder"});
  ...
  setAddress(folder: string) {
    ...
    for(const l of lines) {
      addr += "/" + l
      let btnAddr = addr
      const btn = new UI.Button({caption: l, theme: "button-dlg"})
